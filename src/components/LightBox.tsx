...
const LightBox = ({
    ...
    return (
        ...
        >
            <div className="relative flex flex-col gap-6 max-w-[315px] sm:max-w-[485px] lg:max-w-[700px] lg:max-h-[700px] ">
                ...
                <div
                    ...
                    className="cursor-pointer bg-white flex items-center justify-center h-12 w-12 rounded-full absolute text-orange top-[37.5%] -translate-x-1/2 left-0"
                >
                    <IconPrevious />
                </div>
                <div
                    onClick={(e: any) => nextSlide(e)}
                    className="cursor-pointer bg-white flex items-center justify-center h-12 w-12 rounded-full absolute text-orange top-[37.5%] translate-x-1/2 right-0"
                >
                    <IconNext />
                </div>
